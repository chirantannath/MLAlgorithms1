...
public final class Float64Dataset extends Dataset<Float64Row> {
  ...
  @Override public Stream<Double> columnStream(int column) throws IndexOutOfBoundsException {
  ...
  @Override public Float64Dataset project(final int ... indices) throws IndexOutOfBoundsException {
