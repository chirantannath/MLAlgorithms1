...
public interface Row {
  ...
  default Class<?> getColumnClass(int index) throws IndexOutOfBoundsException {return getColumnClasses()[index];}
  /** Gets the length of the row. */
  default int getRowLength() {return getColumnClasses().length;}
  /** Gets an attribute. */
